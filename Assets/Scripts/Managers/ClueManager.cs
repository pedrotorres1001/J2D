...
public class ClueManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            { artifact1st, "There’s somethin’ strange about this volcano. The way it shakes, it’s almost as if it’s breathin’. \n\n We’ve all heard the old legend about the mountain havin’ a heart. Who’d believe such nonsense?\n \n Still, the tale’s been told for over a hundred years. A madman by the name o’ ‘Crazy Joe’ claimed he stumbled on some sort o’ artifact deep in the mountain—a thing shaped like a heart. Said it could command the fire itself, directin’ the lava and the fury o’ the earth to his will." },
            { artifact2nd, "That’s how he earned his name, after all. \n\n Joe was always mutterin’, ‘The one who wields the heart becomes king.’ Bold talk from a loon. But he also swore it was buried in the deepest veins o’ the volcano. Course, no dwarf has ever dug that far—or dared to try." },
